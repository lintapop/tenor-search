export var COMPONENT_CHANGE_HANDLE = Symbol('Component change handle');
...
function defaultInitialize(target, overrides) {
...
function BaseComponent(_a) {
    ...
    return _b = /** @class */ (function () {
            function BaseComponent() {
                var _this = this;
                this.id = 0;
                this.type = Object.getPrototypeOf(this).constructor.id;
                this.reset = function () {
            ...
            Object.defineProperty(BaseComponent.prototype, "updated", {
                 ...
                 */
                set: function (_) {
                    this[COMPONENT_CHANGE_HANDLE](this);
                },
                enumerable: false,
                configurable: true
            });
