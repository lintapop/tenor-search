...
var sparse_map_1 = __importDefault(require("mnemonist/sparse-map"));
var EntityManager = /** @class */ (function (_super) {
    __extends(EntityManager, _super);
    function EntityManager(__game) {
        var _this = _super.call(this) || this;
        _this.__game = __game;
        _this.pool = new objectPool_1.ObjectPool(function () { return new Entity_1.Entity(_this.__game); });
        _this._destroyList = new Array();
        _this.entityMap = new sparse_map_1.default(_this.__game.constants.maxEntities);
    ...
    EntityManager.prototype.create = function (ownId) {
        ...
        logger_1.logger.debug("Added " + id);
        return ent;
    };
    ...
    EntityManager.prototype.destroy = function (id) {
        ...
        logger_1.logger.debug("Queueing " + id + " for destroy");
    };
